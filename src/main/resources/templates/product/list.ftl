    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
                        ...
                        <tr>
                            ...
                            <td>
                                <#if productInfo.getProductStatusEnum().code == 0>
                                    <a href="/sell/seller/product/off-sale?productId=${productInfo.productId}">下架</a>
                                <#else>
                                    <a href="/sell/seller/product/on-sale?productId=${productInfo.productId}">上架</a>
                                </#if>
            ...
            <div class="col-md-12 column">
                ...
                <#list 1..productInfoPage.getTotalPages() as idx>
                    <#if currentPage == idx>
